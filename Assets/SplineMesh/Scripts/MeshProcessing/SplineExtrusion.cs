...
namespace SplineMesh {
    ...
    public class SplineExtrusion : MonoBehaviour {
        ...
        private void Reset() {
            shapeVertices.Clear();
            shapeVertices.Add(new ExtrusionSegment.Vertex(new Vector2(-1, 0.5f), new Vector2(0, 1), 0));
            shapeVertices.Add(new ExtrusionSegment.Vertex(new Vector2(1, -0.5f), new Vector2(1, 0), 0));
            shapeVertices.Add(new ExtrusionSegment.Vertex(new Vector2(-1, -0.5f), new Vector2(-0.5f, -1), 0));
            shapeVertices.Add(new ExtrusionSegment.Vertex(new Vector2(-1, 0.5f), new Vector2(-1, 0), 0));
            shapeVertices.Add(new ExtrusionSegment.Vertex(new Vector2(1, 0.5f), new Vector2(0.5f,1), 0));
            shapeVertices.Add(new ExtrusionSegment.Vertex(new Vector2(1, -0.5f), new Vector2(0, -1), 0));
